...
const moment = (id: string, at: string, person_id: string | null, by: string | null): Moment => ({
  id, circle_id: 'c', person_id, author_person_id: by, author: null, body: id, photo_url: null, audio_url: null, created_at: at,
});
